...
import { listarModelos, getModeloById, crearModelo, actualizarModelo, borrarModelo } from '../controllers/modelo_dron.controller.js';
import { verificarToken, verificarAdmin } from '../middlewares/auth.middleware.js';

const router = Router();

router.get('/modelos', verificarToken, listarModelos);
router.get('/modelos/:id', verificarToken, getModeloById);
